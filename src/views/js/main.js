...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        ...
        for (var i = randomPizza.length; i--;) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var elem; // Moved outside the for loop to prevent it from being created every time the loop is executed.
    var movingPizzas1tag = document.getElementById('movingPizzas1');
