...
var resizePizzas = function(size) {
  ...
  var randomPizza = document.querySelectorAll(".randomPizzaContainer"); // Moved this variable outside the function to reduce iterations to fetch the data.
...
function updatePositions() { // Added cachedScrollTop outside the for loop.
  frame++;
