...
var resizePizzas = function(size) {
  ...
  var randomPizza = document.querySelectorAll(".randomPizzaContainer"); // Moved variable outside the function to reduce iterations.
...
function updatePositions() {
  ...
  var cachedScrollTop = document.body.scrollTop; // Added cachedScrollTop outside for loop
...
// Generates the sliding pizzas when the page loads.
    document.addEventListener('DOMContentLoaded', function() {
      var cols = 8;
      var s = 256;
    for (var cols = 8, s = 256, i = 30; i--; ) { // Modified loop to be more efficient and removed process of resizing.
